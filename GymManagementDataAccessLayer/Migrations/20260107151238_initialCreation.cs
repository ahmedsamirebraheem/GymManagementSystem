        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneCheck", "PhoneNumber LIKE '01%' AND PhoneNumber NOT LIKE '%[^0-9]%' AND LEN(PhoneNumber) = 11");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Plan_DurationDays_Check", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("GymUserValidPhoneCheck1", "PhoneNumber LIKE '01%' AND PhoneNumber NOT LIKE '%[^0-9]%' AND LEN(PhoneNumber) = 11");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("SessionCapacity_Check", "Capacity Between 1 and 25");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberSessions_MemberId_SessionId",
